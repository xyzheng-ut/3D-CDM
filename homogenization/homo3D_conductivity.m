...
keMu(1:3:end,1:3:end) = keMu(1:3:end,1:3:end) + keMu(2:3:end,2:3:end) + keMu(3:3:end,3:3:end);
...
X = zeros(ndof,3);
for i = 1:3
    X(4:3:end,i) = pcg(K(4:3:end,4:3:end), F(3+i:3:end,i),1e-10,300,L,L');
end
...
X0_e(4:3:end,1:3) = keMu(4:3:end,4:3:end)\[feMu(4:3:end,1),feMu(5:3:end,2),feMu(6:3:end,3)];
